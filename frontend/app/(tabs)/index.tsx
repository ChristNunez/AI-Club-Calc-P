...
export default function HomeTab() {
  ...
  // live problem id (avoid stale closures / expired id)
  const problemIdRef = useRef<string | null>(null);

  // avoid StrictMode double-load in dev
  const didInit = useRef(false);

  // ignore late /new-problem responses (race-proof)
  ...
  async function onCheck() {
    ...
    try {
      ...
      // if server says expired, fetch new and inform
